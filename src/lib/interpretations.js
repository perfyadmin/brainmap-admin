...
export const discInterpretations = {
  D: {
...
export const mbtiInterpretations = {
...
export const intelligenceDescriptions = {
...
export const careerTypeDetails = {
...
export function generateCorrelationInsight(disc, mbti, iq, eq, aq, cq, learningStyle, topIntelligences) {
...
export function generateActionPlan(iq, eq, aq, cq, learningStyle, career) {
  const skillDev = [];
  const dailyPlan = [];
  const behaviourPlan = [];
...
export function generateCareerRoadmap(career, roles) {
  return {
    shortTerm: [
